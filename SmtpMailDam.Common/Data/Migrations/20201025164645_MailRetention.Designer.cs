...
namespace SmtpMailDam.Common.Data.Migrations
{
    ...
    [Migration("20201025164645_MailRetention")]
    partial class MailRetention
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmtpMailDam.Common.Models.Mail", b =>
                {
            ...
            modelBuilder.Entity("SmtpMailDam.Common.Models.Mailbox", b =>
                {
                    b.Property<Guid>("MailboxId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("ImapSSLEnabled")
                        .HasColumnType("bit");

                    b.Property<string>("ImapUsername")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("MailRetention")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmtpMailDam.Common.Models.Mail", b =>
                {
                    b.HasOne("SmtpMailDam.Common.Models.Mailbox", null)
                        .WithMany("Mails")
